...
const inputClass =
  "w-full rounded-sm border-[1.5px] border-line-heavy bg-paper px-3 py-2.5 font-sans text-sm text-ink outline-none transition-[border-color,background] focus:border-ink focus:bg-card";
